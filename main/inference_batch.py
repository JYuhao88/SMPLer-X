...
def get_bbox_from_detector(mmdet_box, img_width, img_height):
    ...
    # if mmdet_box_xywh[2] < bbox_thr or mmdet_box_xywh[3] < bbox_thr * 3:
    #     continue
...
def gennrate_inputs(original_imgs, mmtrack_boxes, batch_size):
    from common.utils.preprocessing import generate_patch_image
...
def main():
    ...
    inputs, input_structure = gennrate_inputs(
        original_imgs,
        mmtrack_boxes,
        args.batch_size,
    )
